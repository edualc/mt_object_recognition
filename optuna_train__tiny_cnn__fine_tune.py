...
def check_mnist_c(model, wandb_run_name):
    ...
    df['model_type'] = 'TinyCNN__Optuna_BestRun__FineTune2'
...
def train_model(study):
    ...
    wandb_group_name = 'TinyCNN_Optuna__FinalRun__ConvPreTrained2'
...
def main():
    study_name = 'tiny_cnn__optuna__conv_pre_trained'
